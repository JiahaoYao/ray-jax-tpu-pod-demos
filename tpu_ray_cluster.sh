...
for i in 1 2 3 
do 
    gcloud alpha compute tpus tpu-vm ssh jax-trainer-mnist-tpu-pod --zone=us-central1-a --command "ray stop && ray start --address='${head_ip}:6379' --resources='{\"TPU\":1}'" --worker=$i
done 
